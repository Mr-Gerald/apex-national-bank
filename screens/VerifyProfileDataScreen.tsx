...
const VerifyProfileDataScreen: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        setIsLoading(false);
        navigate(`/profile-verification/upload-id`);
      }, 1200);
    } catch (error: any) {
  ...
  return (
    <div className="p-4 space-y-6">
      <StepIndicator currentStep={1} totalSteps={4} flowType="profile" />
      <div className="flex items-center space-x-3 mb-4">
        <h1 className="text-2xl font-semibold text-neutral-800">Verify for Top-Tier Access (Step 1/4)</h1>
      </div>

      <p className="text-sm text-neutral-600">Please provide or confirm your personal information to unlock enhanced account features and security.</p>
...
export default VerifyProfileDataScreen;
